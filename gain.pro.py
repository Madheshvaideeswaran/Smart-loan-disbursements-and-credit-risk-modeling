...
for pkg in ['catboost', 'statsmodels', 'plotly', 'fpdf2', 'openpyxl', 'matplotlib']:
    try:
        __import__(pkg)
    except ImportError:
        import subprocess
...
with tab3:
    ...
    # === PDF Export — USE MATPLOTLIB FOR RELIABLE CHART ===
    ...
    def create_pdf():
        ...
        # Save and embed
        plt.savefig("temp_forecast.png", dpi=150)
        plt.close()
        ...
        # Cleanup
        if os.path.exists("temp_forecast.png"):
