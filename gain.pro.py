...
def get_theme_color(risk_delta):
    if risk_delta > 0.15: return "#d62828"
    elif risk_delta > 0.05: return "#f77f00"
    elif risk_delta < -0.15: return "#06d6a0"
    elif risk_delta < -0.05: return "#8ac926"
    else: return "#1e88e5"

# =============================
# Tab 1: CatBoost Classification
# =============================
with tab1:
...
with tab3:
    ...
    fig.update_layout(
        ...
        xaxis=dict(
            title=dict(text="Date", font=dict(size=16, color='black')),
        ...
        yaxis=dict(
            title=dict(text="Disbursement Volume", font=dict(size=16, color='black')),
            tickfont=dict(size=13, color='black'),
            showgrid=True,
            gridcolor='lightgray',
            zeroline=False
