...
# =============================
# Tab 3: SARIMAX Forecast — 100% CLOUD-SAFE GRAPH
# =============================
with tab3:
    ...
    # === Interactive Plotly Chart — 100% CLOUD-SAFE ===
    fig = go.Figure()
    ...
    # ✅ 100% SAFE LAYOUT — ONLY size + color (NO weight, NO family)
    fig.update_layout(
        title=dict(
            text="12-Month Disbursement Forecast: Baseline vs Adjusted Scenario",
            font=dict(size=20, color='black')  # ↑ Larger size for emphasis
        ),
        xaxis=dict(
            title="Date",
            titlefont=dict(size=16, color='black'),  # ↑ Larger = bold effect
    ...
    def create_pdf():
        ...
        try:
            ...
            pass  # Silent fallback — no warning
