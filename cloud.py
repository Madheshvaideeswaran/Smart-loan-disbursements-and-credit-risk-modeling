...
for pkg in ['catboost', 'statsmodels', 'plotly', 'fpdf2', 'openpyxl']:
    try:
        __import__(pkg)
    except ImportError:
        import subprocess
...
with tab3:
    ...
    # ➡️ CHANGE 1: REPLACED DEPRECATED titlefont/tickfont WITH FLAT PROPERTIES
    fig.update_layout(
    ...
    def create_pdf():
        ...
        chart_saved = False
        try:
            # ➡️ CHANGE 2: REMOVED engine="kaleido" — let Plotly auto-select
            fig.write_image("temp_forecast.png", width=800, height=400)
